...
//
		...
		//f (Controls.getBind("Menu_Accept", "JUST_PRESSED"))
		//	{
		//		selectWeek();
		//	}
	}
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			for(i in 0...weekData[curWeek][1].lenght){
				...
				states.PlayState.SongListData.addSong(song);
			}
			states.PlayState.SongListData.resetVariables();
			new FlxTimer().start(1, function(tmr:FlxTimer){
				states.PlayState.SongListData.playWeek();
			});		
		}
	}
