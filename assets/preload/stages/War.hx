...
function create():Void {
	...
	background.loadGraphic(SavedFiles.getGraphic(Paths.image('sky', 'stages/war')));
	...
	clouds.loadGraphic(SavedFiles.getGraphic(Paths.image('clouds', 'stages/war')));
	instance.add(clouds);

	mountains = new FlxSprite(-400, 100);
	mountains.scrollFactor.set(0.2, 0.2);
	mountains.loadGraphic(SavedFiles.getGraphic(Paths.image('mountains', 'stages/war')));
	instance.add(mountains);

	buildings = new FlxSprite(-200, 130);
	buildings.scrollFactor.set(0.3, 0.3);
	buildings.loadGraphic(SavedFiles.getGraphic(Paths.image('ruins', 'stages/war')));
	instance.add(buildings);

	ruins = new FlxSprite(-180, 500);
	ruins.scrollFactor.set(0.4, 0.4);
	ruins.loadGraphic(SavedFiles.getGraphic(Paths.image('ruins1', 'stages/war')));
	instance.add(ruins);

	smokeLeft = new FlxSprite(0, 0);
	smokeLeft.scrollFactor.set(0.4, 0.4);
	smokeLeft.frames = SavedFiles.getAtlas(Paths.image('leftsmoke', 'stages/war'));
	...
	smokeRight.frames = SavedFiles.getAtlas(Paths.image('rightsmoke', 'stages/war'));
	...
	watchtower.frames = SavedFiles.getAtlas(Paths.image('watchtower', 'stages/war'));
	...
	tankrolling.frames = SavedFiles.getAtlas(Paths.image('rolltank', 'stages/war'));
	...
	ground.loadGraphic(SavedFiles.getGraphic(Paths.image('ground', 'stages/war')));
	instance.add(ground);
	...
	tank1.frames = SavedFiles.getAtlas(Paths.image('tank3', 'stages/war'));
	...
	tank2.frames = SavedFiles.getAtlas(Paths.image('tank1', 'stages/war'));
	...
	tank4.frames = SavedFiles.getAtlas(Paths.image('tank2', 'stages/war'));
...
function preload():Void {
    ...
    for(n in shootStrumLine.notelist){  
		...
		new_tank.frames = SavedFiles.getAtlas(Paths.image('walk_tank', 'stages/war'));
