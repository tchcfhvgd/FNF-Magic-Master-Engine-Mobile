...
function startSong(startCountdown:Void->Void):Void {
    ...
    Timer.delay(function(){
        ...
        FlxG.sound.play(Paths.sound("ugh_1", "stages/war"), 1, false, null, true, function(){
            Character.setCameraToCharacter(boyfriend, camFollow);
    
            Timer.delay(function(){
                boyfriend.playAnim("singUP");
                FlxG.sound.play(Paths.sound("ugh_2", "stages/war"), 1, false, null, true, function(){
                    boyfriend.playAnim("idle");
                    Timer.delay(function(){
                        Character.setCameraToCharacter(tankman, camFollow);
                        
                        tankman.playAnim("Cinematic_UGH_2", true, true, false, 0);
                        FlxG.sound.play(Paths.sound("ugh_3", "stages/war"), 1, false, null, true, function(){
                            onCinematic = false;
